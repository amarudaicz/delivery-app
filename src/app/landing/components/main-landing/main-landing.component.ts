...
export class MainLandingComponent implements OnInit {
  ...
  constructor(private pwa: PwaInstallerService, private themeService:ThemesService, private layoutState:LayoutStateService) {
    localStorage.getItem('landing-banner') ? this.currentBanner = 0 : this.currentBanner = 1;
